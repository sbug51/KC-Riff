...
A model file is the blueprint to create and share models with kcriff.
...
| [`PARAMETER`](#parameter)           | Sets the parameters for how kcriff will run the model.         |
...
2. `kcriff create choose-a-model-name -f <location of the file e.g. ./Modelfile>`
3. `kcriff run choose-a-model-name`
4. Start using the model!

To view the Modelfile of a given model, use the `kcriff show --modelfile` command.

```shell
kcriff show --modelfile llama3.2
```

> **Output**:
>
> ```
> # Modelfile generated by "kcriff show"
> # To build a new Modelfile based on this one, replace the FROM line with:
> # FROM llama3.2:latest
> FROM /Users/pdevine/.kcriff/models/blobs/sha256-00e1317cbf74d901080d7100f57580ba8dd8de57203072dc6f668324ba545f29
